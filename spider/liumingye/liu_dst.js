...
function encode(_0xa6f0d) {
    // Location
    // {
    //     ancestorOrigins: DOMStringList, href
    // :
    //     'http://tool.liumingye.cn/music/?page=audioPage&type=migu&name=%E9%99%88%E5%A5%95%E8%BF%85', origin
    // :
    //     'http://tool.liumingye.cn', protocol
    // :
    //     'http:', host
    // :
    //     'tool.liumingye.cn', …
...
console.log("========");
let res = encode("text=陈奕迅&page=1&type=migu");
// console.log(res)
