...
SVGDescElement = v_saf(function SVGDescElement(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };}); _inherits(SVGDescElement, SVGElement)
...
SVGClipPathElement = v_saf(function SVGClipPathElement(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };}); _inherits(SVGClipPathElement, SVGElement)
...
SVGRectElement = v_saf(function SVGRectElement(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };}); _inherits(SVGRectElement, SVGGeometryElement)
SVGGElement = v_saf(function SVGGElement(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };}); _inherits(SVGGElement, SVGGraphicsElement)
...
SVGTextElement = v_saf(function SVGTextElement(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };}); _inherits(SVGTextElement, SVGTextPositioningElement)
...
HTMLParamElement = v_saf(function HTMLParamElement(){if (!v_new_toggle){ throw TypeError("Illegal constructor") };}); _inherits(HTMLParamElement, HTMLElement)
...
Object.defineProperties(PerformanceTiming.prototype, {
  domainLookupEnd: {get(){ v_console_log("  [*] PerformanceTiming -> domainLookupEnd[get]", 1733143376220);return 1733143376220 }},
  domainLookupStart: {get(){ v_console_log("  [*] PerformanceTiming -> domainLookupStart[get]", 1733143376194);return 1733143376194 }},
  connectEnd: {get(){ v_console_log("  [*] PerformanceTiming -> connectEnd[get]", 1733143376288);return 1733143376288 }},
  connectStart: {get(){ v_console_log("  [*] PerformanceTiming -> connectStart[get]", 1733143376220);return 1733143376220 }},
  responseStart: {get(){ v_console_log("  [*] PerformanceTiming -> responseStart[get]", 1733143376322);return 1733143376322 }},
  requestStart: {get(){ v_console_log("  [*] PerformanceTiming -> requestStart[get]", 1733143376288);return 1733143376288 }},
  navigationStart: {get(){ v_console_log("  [*] PerformanceTiming -> navigationStart[get]", 1733143376189);return 1733143376189 }},
...
Object.defineProperties(DOMRectReadOnly.prototype, {
  ...
  left: {get(){ v_console_log("  [*] DOMRectReadOnly -> left[get]", 671.5);return 671.5 }},
...
Object.defineProperties(SVGRect.prototype, {
  ...
  width: {get(){ v_console_log("  [*] SVGRect -> width[get]", 22.6845703125);return 22.6845703125 }},
...
Object.defineProperties(Node.prototype, {
  ...
  nodeName: {get(){ v_console_log("  [*] Node -> nodeName[get]", "clipPath");return "clipPath" }},
...
Object.defineProperties(Element.prototype, {
  ...
  id: {get(){ v_console_log("  [*] Element -> id[get]", "tzjy");return "tzjy" },set(){ v_console_log("  [*] Element -> id[set]", [].slice.call(arguments));return "tzjy" }},
  ...
  innerHTML: {get(){ v_console_log("  [*] Element -> innerHTML[get]", "<svg version=\"1.1\" style=\"font-family:&quot;Lucida Grande&quot;, &quot;Lucida Sans Unicode&quot;, Arial, Helvetica, sans-serif;font-size:12px;font-family:Arial;\"></svg>");return "<svg version=\"1.1\" style=\"font-family:&quot;Lucida Grande&quot;, &quot;Lucida Sans Unicode&quot;, Arial, Helvetica, sans-serif;font-size:12px;font-family:Arial;\"></svg>" },set(){ v_console_log("  [*] Element -> innerHTML[set]", [].slice.call(arguments));return "<svg version=\"1.1\" style=\"font-family:&quot;Lucida Grande&quot;, &quot;Lucida Sans Unicode&quot;, Arial, Helvetica, sans-serif;font-size:12px;font-family:Arial;\"></svg>" }},
...
Object.defineProperties(HTMLElement.prototype, {
  ...
  offsetHeight: {get(){ v_console_log("  [*] HTMLElement -> offsetHeight[get]", 120);return 120 }},
  offsetWidth: {get(){ v_console_log("  [*] HTMLElement -> offsetWidth[get]", 255);return 255 }},
  offsetTop: {get(){ v_console_log("  [*] HTMLElement -> offsetTop[get]", -12);return -12 }},
  onload: {set(){ v_console_log("  [*] HTMLElement -> onload[set]", [].slice.call(arguments));return -12 }},
...
Object.defineProperties(HTMLScriptElement.prototype, {
  ...
  src: {get(){ v_console_log("  [*] HTMLScriptElement -> src[get]", "http://d.10jqka.com.cn/v6/time/hs_399006/last.js");return "http://d.10jqka.com.cn/v6/time/hs_399006/last.js" },set(){ v_console_log("  [*] HTMLScriptElement -> src[set]", [].slice.call(arguments));return "http://d.10jqka.com.cn/v6/time/hs_399006/last.js" }},
...
Object.defineProperties(SVGGraphicsElement.prototype, {
  getBBox: {value: v_saf(function getBBox(){v_console_log("  [*] SVGGraphicsElement -> getBBox[func]", [].slice.call(arguments));})},
...
Object.defineProperties(SVGDescElement.prototype, {
  [Symbol.toStringTag]: {value:"SVGDescElement",writable:false,enumerable:false,configurable:true},
})
...
Object.defineProperties(SVGClipPathElement.prototype, {
  [Symbol.toStringTag]: {value:"SVGClipPathElement",writable:false,enumerable:false,configurable:true},
})
...
Object.defineProperties(SVGRectElement.prototype, {
  [Symbol.toStringTag]: {value:"SVGRectElement",writable:false,enumerable:false,configurable:true},
})
Object.defineProperties(SVGGElement.prototype, {
  [Symbol.toStringTag]: {value:"SVGGElement",writable:false,enumerable:false,configurable:true},
})
...
Object.defineProperties(SVGTextElement.prototype, {
  [Symbol.toStringTag]: {value:"SVGTextElement",writable:false,enumerable:false,configurable:true},
})
...
Object.defineProperties(HTMLParamElement.prototype, {
  [Symbol.toStringTag]: {value:"HTMLParamElement",writable:false,enumerable:false,configurable:true},
})
...
init_cookie("v=A4oIpMwt2YiX1VUk72yAUSBT23spew7eAP-CeRTDNl1oxyQl_Ate5dCP0o_n")
...
function v_geteles(name, func){
  ...
  if(name == "[id='sizcache0782789643630305'] tr th" && func == "querySelectorAll"){ return [v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement)] }
  ...
  if(name == "[id='sizcache0782789643630305'] .m-pager-board a[board]" && func == "querySelectorAll"){ return [v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement)] }
  if(name == "m-pager-table" && func == "getElementsByClassName"){ return [v_new(HTMLTableElement),v_new(HTMLTableElement)] }
  if(name == "[id='sizcache0782789643630305'] a[field]" && func == "querySelectorAll"){ return [v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement)] }
  if(name == "[id='sizcache0782789643630305'] .m-pager a[page]" && func == "querySelectorAll"){ return [v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement)] }
  if(name == "[id='sizcache0782789643630305'] .m-pager-board .cur a[board]" && func == "querySelectorAll"){ return [v_new(HTMLAnchorElement)] }
  if(name == "[id='sizcache0782789643630305'] .m-pager-table .cur a[field]" && func == "querySelectorAll"){ return [v_new(HTMLAnchorElement),v_new(HTMLAnchorElement)] }
  if(name == "[id='sizcache0782789643630305'] .m-pager a.cur" && func == "querySelectorAll"){ return [v_new(HTMLAnchorElement)] }
  if(name == ".hcharts-list .item" && func == "querySelectorAll"){ return [v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement)] }
  if(name == "[id='sizcache0782789643630305'] .detail span.c-rise" && func == "querySelectorAll"){ return [v_new(HTMLSpanElement)] }
  if(name == "[id='sizcache0782789643630305'] .detail span.c-fall" && func == "querySelectorAll"){ return [v_new(HTMLSpanElement)] }
  if(name == "tspan" && func == "getElementsByTagName"){ return [v_new(SVGTSpanElement)] }
  if(name == "[id='sizcache0782789643630305'] .detail span" && func == "querySelectorAll"){ return [v_new(HTMLSpanElement)] }
  if(name == "*" && func == "querySelectorAll"){ return [v_new(HTMLHtmlElement),v_new(HTMLHeadElement),v_new(HTMLScriptElement),v_new(HTMLMetaElement),v_new(HTMLTitleElement),v_new(HTMLMetaElement),v_new(HTMLMetaElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLStyleElement),v_new(HTMLLinkElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLBodyElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLAnchorElement),v_new(HTMLImageElement),v_new(HTMLHeadingElement),v_new(HTMLAnchorElement),v_new(HTMLDivElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLUListElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLUListElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLUListElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLDivElement),v_new(HTMLAnchorElement),v_new(HTMLDivElement),v_new(HTMLAnchorElement),v_new(HTMLSpanElement),v_new(HTMLAnchorElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLHeadingElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLHeadingElement),v_new(HTMLParagraphElement),v_new(HTMLSpanElement),v_new(HTMLSpanElement),v_new(HTMLDivElement),v_new(HTMLHeadingElement),v_new(HTMLParagraphElement),v_new(HTMLSpanElement),v_new(HTMLSpanElement),v_new(HTMLDivElement),v_new(HTMLHeadingElement),v_new(HTMLParagraphElement),v_new(HTMLSpanElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(SVGSVGElement),v_new(SVGDescElement),v_new(SVGDefsElement),v_new(SVGClipPathElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTSpanElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTSpanElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTSpanElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTSpanElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTSpanElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTSpanElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTSpanElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTSpanElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTSpanElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTSpanElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(HTMLDivElement),v_new(HTMLSpanElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(SVGSVGElement),v_new(SVGDescElement),v_new(SVGDefsElement),v_new(SVGClipPathElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGTextElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(SVGSVGElement),v_new(SVGDescElement),v_new(SVGDefsElement),v_new(SVGClipPathElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGTextElement),v_new(HTMLDivElement),v_new(HTMLHeadingElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(SVGSVGElement),v_new(SVGDescElement),v_new(SVGDefsElement),v_new(SVGClipPathElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(HTMLDivElement),v_new(HTMLElement),v_new(HTMLParagraphElement),v_new(HTMLLabelElement),v_new(HTMLParagraphElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLElement),v_new(HTMLSpanElement),v_new(HTMLSpanElement),v_new(HTMLSpanElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(SVGSVGElement),v_new(SVGDescElement),v_new(SVGDefsElement),v_new(SVGClipPathElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGTextElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGTextElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLElement),v_new(HTMLSpanElement),v_new(HTMLSpanElement),v_new(HTMLSpanElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(SVGSVGElement),v_new(SVGDescElement),v_new(SVGDefsElement),v_new(SVGClipPathElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGTextElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGTextElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLElement),v_new(HTMLSpanElement),v_new(HTMLSpanElement),v_new(HTMLSpanElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(SVGSVGElement),v_new(SVGDescElement),v_new(SVGDefsElement),v_new(SVGClipPathElement),v_new(SVGRectElement),v_new(SVGRectElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGPathElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGTextElement),v_new(SVGGElement),v_new(SVGGElement),v_new(SVGTextElement),v_new(SVGTextElement),v_new(SVGGElement),v_new(SVGPathElement),v_new(SVGTextElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLElement),v_new(HTMLSpanElement),v_new(HTMLSpanElement),v_new(HTMLSpanElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLHeadingElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLHeadingElement),v_new(HTMLAnchorElement),v_new(HTMLHeadingElement),v_new(HTMLAnchorElement),v_new(HTMLHeadingElement),v_new(HTMLAnchorElement),v_new(HTMLHeadingElement),v_new(HTMLAnchorElement),v_new(HTMLHeadingElement),v_new(HTMLAnchorElement),v_new(HTMLHeadingElement),v_new(HTMLAnchorElement),v_new(HTMLDivElement),v_new(HTMLTableElement),v_new(HTMLTableSectionElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLDivElement),v_new(HTMLTableElement),v_new(HTMLTableSectionElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLTableSectionElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableRowElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLAnchorElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLTableCellElement),v_new(HTMLInputElement),v_new(HTMLInputElement),v_new(HTMLDivElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLAnchorElement),v_new(HTMLSpanElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDListElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLDListElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLDListElement),v_new(HTMLElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLElement),v_new(HTMLAnchorElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLHeadingElement),v_new(HTMLSpanElement),v_new(HTMLDivElement),v_new(HTMLParagraphElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLParagraphElement),v_new(HTMLAnchorElement),v_new(HTMLSpanElement),v_new(HTMLAnchorElement),v_new(HTMLSpanElement),v_new(HTMLAnchorElement),v_new(HTMLSpanElement),v_new(HTMLAnchorElement),v_new(HTMLSpanElement),v_new(HTMLAnchorElement),v_new(HTMLSpanElement),v_new(HTMLAnchorElement),v_new(HTMLSpanElement),v_new(HTMLAnchorElement),v_new(HTMLSpanElement),v_new(HTMLAnchorElement),v_new(HTMLSpanElement),v_new(HTMLAnchorElement),v_new(HTMLSpanElement),v_new(HTMLAnchorElement),v_new(HTMLParagraphElement),v_new(HTMLAnchorElement),v_new(HTMLParagraphElement),v_new(HTMLParagraphElement),v_new(HTMLAnchorElement),v_new(HTMLDivElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLImageElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLObjectElement),v_new(HTMLParamElement),v_new(HTMLParamElement),v_new(HTMLParamElement),v_new(HTMLParamElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLUListElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLLIElement),v_new(HTMLAnchorElement),v_new(HTMLDivElement),v_new(HTMLCanvasElement),v_new(HTMLDivElement),v_new(HTMLCanvasElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLUListElement),v_new(HTMLLIElement),v_new(HTMLSpanElement),v_new(HTMLSpanElement),v_new(HTMLLIElement),v_new(HTMLSpanElement),v_new(HTMLSpanElement),v_new(HTMLDivElement),v_new(HTMLDivElement),v_new(HTMLSpanElement),v_new(HTMLDivElement),v_new(HTMLSpanElement),v_new(HTMLSpanElement)] }
...
var TOKEN_SERVER_TIME = 1733141051.238;
!function(n, t) {
    !function() {
        var r, e, a;
        r = e = a = n;
...
console.log("finally cookie->",document.cookie)